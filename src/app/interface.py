...
def get_machine_vars(machine):
    ...
    def get_planned_operating_time(machine):
        if (machine.schedule is not None
            ...
            return True if 'switch-program' in action.__name__ else 0
        else:
            return False
    ...
    d = {}
    d['Status'] = {
        'func': partial(get_state, machine=machine),
        'val': -1
    }
    ...
    d['Program'] = {
        'func': lambda: machine.program.uid,
        'val': 'null'
    }
