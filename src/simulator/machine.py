...
from src.simulator.causes import BaseCause, ManualSwitchOffCause, \
...
from src.simulator.containers import ConsumableContainer, MaterialContainer, \
    ProductContainer
from src.simulator.issues import ProductionIssue, OverheatIssue
from src.simulator.program import Program
from src.simulator.schedules import OperatingSchedule
from src.simulator.utils import ignore_causes, AttributeMonitor
...
class Machine(Base):
    ...
    def __init__(
        ...
        self.procs = {
            ...
            'room_temperature':
                self.env.process(self._room_temperature_proc()),
