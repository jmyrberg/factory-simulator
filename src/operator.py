...
from src.utils import AttributeMonitor, ignore_causes, with_obj_monitor
...
class Operator(Base):
    ...
    def __init__(self, env, machine=None, name='operator'):
        ...
        # Internal resources
        self.attention = self.with_monitor(simpy.PreemptiveResource(env))
